...
import com.example.android_school_spacex.databinding.ItemRocketDetailBinding
...
class RocketDetailController :
    ...
    inner class Holder(parent: ViewGroup) :
        BindableViewHolder<SeparateRocketDetail>(parent, R.layout.item_rocket_detail) {

        private val binding = ItemRocketDetailBinding.bind(itemView)
